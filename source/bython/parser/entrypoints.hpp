...
auto module(std::string_view code,
            error_callback report_error = lexy_ext::report_error)
    -> lexy::parse_result<ast::mod, error_callback>;

auto expression(std::string_view code,
                error_callback report_error = lexy_ext::report_error)
    -> lexy::parse_result<std::unique_ptr<ast::expression>, error_callback>;

auto statement(std::string_view code,
               error_callback report_error = lexy_ext::report_error)
